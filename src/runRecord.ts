import type { DetectedProject, RunRecord, ValidationResult } from "./types.js";
import type { GitState } from "./git.js";
import { determineReadiness, generateRiskFlags } from "./riskFlags.js";
import { discoverValidationCommands } from "./validation.js";

export function createRunRecord(input: { runId: string; createdAt: string; git: GitState; project: DetectedProject; requested: string[]; results: ValidationResult[] }): RunRecord {
