...
describe("handoff quality output", () => {
  it("writes quality review to the run and latest bundles", async () => {
    ...
    const files = { "HANDOFF.md": renderHandoff(record), "QA_REPORT.md": renderQaReport(record), "AGENT_HANDOFF.md": renderAgentHandoff(record), "QUALITY_REVIEW.md": renderQualityReview(record), "RUN_COMPARISON.md": renderRunComparison(record), "RUN_RECORD.json": `${JSON.stringify(record, null, 2)}\n` };
